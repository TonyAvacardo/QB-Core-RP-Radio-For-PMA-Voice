radioConfig = {
    ...
    Frequency = {
        ...
        [1] = true,-- Police & Aambulance
        [2] = true,-- Police & Aambulance
        [3] = true,-- Police & Aambulance
        [4] = true,-- Police & Aambulance
        [5] = true,-- Police & Aambulance
        [6] = true,-- Police & Aambulance
        [7] = true,-- Police & Aambulance
        [8] = true,-- Police & Aambulance
        [999] = true, -- Gang 1
        [998] = true, -- Gang 2
        [997] = true, -- Gang 3
        [996] = true  -- Gang 4
